...
<table class="listing resources">
    ...
    <tr class="listing-row">
        <td>
            <a href="/app/manage/{{$current_org->slug}}/physical-resources/{{$resource_detail->pt_id}}">
        ...
        <td class="action">
            <form action="/app/manage/{{$current_org->slug}}/physical-resources/{{$resource_detail->pt_id}}" method="POST">
                {{ method_field("DELETE") }}
