...
<table class="listing resources">
    ...
    <tr>
        <td>
            <a href="/app/manage/{{$current_org->slug}}/digital-resources/{{$resource_detail->pt_id}}">
        ...
        <td class="action">
            <form action="/app/manage/{{$current_org->slug}}/digital-resources/{{$resource_detail->pt_id}}" method="POST">
                {{ method_field("DELETE") }}
